...
IGNORED_LESSONS = ["CYCLING", "BARRE workout", "Cvičení pro těhotné", "MAMINKY", "BOSU"]
...
class FormFactorySchedulesHandler:
    def __init__(self, gym: str, domain_name: str, parse_from: str):
        ...
        self.schedule_url = f"https://{domain_name}.formfactory.cz/calendar"
