...
SCHEDULE_URL = "https://siddha-yoga.isportsystem.cz/ajax/ajax.schema.php"
HEADERS = {
    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Safari/537.36",
    "Accept": "application/json, text/javascript, */*; q=0.01",
    "Referer": "https://siddha-yoga.isportsystem.cz/",
...
def parse_schedule(html):
    ...
    for date, lessons in lessons_by_dates.items():
        days.append({"date": date, "gym": "Siddha Yoga", "lessons": lessons})
